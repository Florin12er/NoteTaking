    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-900">
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="text-center">
          ...
          >
            Organize, collaborate, and bring your ideas to life with our
          ...
          {[
            {
              ...
              description: "Jot down your ideas quickly and effortlessly.",
            },
            {
              icon: Layout,
              title: "Organize Your Thoughts",
              description: "Categorize and structure your notes with ease.",
            },
            {
              icon: Users,
              title: "Collaborate Seamlessly",
              description: "Share and work together on projects in real-time.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="w-full bg-gray-800 text-white py-3 rounded-full hover:bg-gray-900 transition duration-300 mb-4 flex items-center justify-center font-semibold shadow-md hover:shadow-lg"
              >
                <svg
              ...
              <button
                ...
                className="w-full bg-white text-black py-3 rounded-full hover:bg-zinc-200 transition duration-300 flex items-center justify-center font-semibold shadow-md hover:shadow-lg"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
