...
const NoteEditor: React.FC = () => {
    ...
    const handleDashboardImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-4 bg-gray-50 border-b border-gray-200">
                ...
                {dashboardImagePreview && (
                    <div className="mt-4">
                        <img src={dashboardImagePreview} alt="Dashboard Preview" className="max-w-full h-32 object-cover rounded-md" />
                    </div>
                )}
            </div>
